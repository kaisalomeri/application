...
class ProprtyRent extends StatefulWidget {
  ProprtyRent();

  @override
  _ProprtyRentState createState() => _ProprtyRentState();
}

class _ProprtyRentState extends State<ProprtyRent> {
  ...
  Future<Map<String, dynamic>> fetchAllData() async {
    ...
    try {
      var data = await apiService.getProprtyRent();
      return data;
    } catch (e) {
      print('Error: $e');
