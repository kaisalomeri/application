...
class Apartme extends StatefulWidget {
  const Apartme({super.key});

  @override
  _ApartmeState createState() => _ApartmeState();
}

class _ApartmeState extends State<Apartme> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          buildSwitchButton('مبنى تجاري', 'مبنى سكني', rentCategory, (value) {
            setState(() {
              rentCategory = value;
            });
          }),
          ...
          buildSwitchButton('قديم', ' جديدة', rentCategory, (value) {
            setState(() {
              rentCategory = value;
            });
          }),
